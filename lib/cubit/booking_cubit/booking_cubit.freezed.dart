...
abstract class $BookingStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Booking> bookings, bool isLoading, String error});
}
...
class _$BookingStateImpl implements _BookingState {
  ...
  @override
  String toString() {
    return 'BookingState(bookings: $bookings, isLoading: $isLoading, error: $error)';
  }
...
abstract class _BookingState implements BookingState {
  const factory _BookingState(
      ...
      final bool isLoading,
      final String error}) = _$BookingStateImpl;
